module.exports = (sequelize, dataTypes) => {
    ...
    let cols = {
        ...
        title: {
            ...
            allowNull: false,
            validate:{ //configuracion custom de validacion
                notNull:{
                    args:true,//argumentos
                    msg:"Title can't be null papá"
                },
                notEmpty:{
                    args:true,
        ...
        release_date: {
            ...
            validate:{ //configuracion custom de validacion
                notNull:{
                    args:true,//argumentos
                    msg:"release can't be null papá"
                },
                notEmpty:{
                    args:true,
                    msg:"Write the release date"
                }
        },
